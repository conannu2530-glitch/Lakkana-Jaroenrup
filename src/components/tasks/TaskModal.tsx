            ...
            <div className="space-y-8">
              ...
              <div className="space-y-2">
                <input
                  ...
                  className={cn(
                    "w-full text-3xl font-bold text-slate-900 border-none focus:ring-0 p-0 placeholder:text-slate-300",
                    error && "text-red-500"
                  )}
              ...
              <div className="space-y-3">
                ...
                <textarea
                  ...
                  className="w-full min-h-[150px] bg-slate-50 border-none rounded-xl p-4 text-slate-700 focus:ring-2 focus:ring-blue-500 transition-all resize-none"
                />
              </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 space-y-2">
                    <textarea
                      ...
                      className="w-full bg-white border border-slate-200 rounded-xl p-3 text-sm focus:ring-2 focus:ring-blue-500 transition-all resize-none"
                      rows={2}
                    />
                      ...
                      <div key={comment.id} className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-[10px] text-slate-400">{format(new Date(comment.timestamp), 'MMM d, h:mm a')}</span>
                          </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <select 
                    ...
                    className="w-full bg-slate-100 border-none rounded-lg text-sm font-medium p-2.5 focus:ring-2 focus:ring-blue-500"
                  >
                    {data.statuses.map(s => (
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3 p-2.5 bg-slate-100 rounded-lg">
                    <select 
                      ...
                      className="flex-1 bg-transparent border-none text-sm font-medium p-0 focus:ring-0"
                    >
                      {data.users.map(u => (
